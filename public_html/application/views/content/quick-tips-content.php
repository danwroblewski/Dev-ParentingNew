...
<div class="container">
	<div class="sixteen contentcolumn columns alpha omega">
		...
		#echo"<pre>";print_r($item);
			...
			<div class="content">
				<p><?php echo $item->field_quick_tips_body->und[0]->value; ?></p>
			<ul>
				<?php 
				for($i=0;$i<count($item->field_quick_tips->und);$i++){ ?>
					<li><?php echo $item->field_quick_tips->und[$i]->value; ?></li>
				<?php } ?>
			</ul></div>		
			...
			<img src="/img/printtray_blurtop.png" width="100%" />
				<div class="twelve contentnav columns">
					<div class="contentnavleft"><a href="/quick-tips" class="btn-back-quicktips"><span>Back</span></a></div>  
