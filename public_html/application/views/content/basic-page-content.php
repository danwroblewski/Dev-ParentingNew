		...
		<div class="twelve incontent columns">
			...
			<img src="/img/printtray_blurtop.png" width="100%" />
				<div class="twelve contentnav columns">
					...
					<!-- <div class="contentnavleft"><a href="/article" class="btn-back-articles"><span>Back</span></a></div> -->
					
					
					<div class="block block-block" id="block-block-82">
						<!-- <h2 class="title"></h2> -->
						<div class="content"><p><a class="askQuestion" href="/ask-an-expert/ask-expert">Ask a Question to a Boys Town Expert</a></p></div>
					 </div>					
				...
				<div class="twelve tags columns" style="margin:0;">
					<div align="center">
						<?php /*if($tags<>""){?><p style="margin:0;"><strong>Tags:</strong><?php foreach($tags as $tag):
