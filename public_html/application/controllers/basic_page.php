...
class Basic_Page extends MY_Controller {
	...
	public function index()
	{
		...
		$this->data['list'] 		= $this->Ws_Formater_Model->get_list_all('basic-page');
...
//--------------------------------------------------------------------
	public function basic_page_content()
	{
		$this->load->helper('text');
		
		$this->load->model('Ws_Formater_Model');
		$nid					= $this->Ws_Formater_Model->_set_nid(2, 'basic-page');
		...
		$this->data['item'] 	      	= $this->Ws_Formater_Model->get_entry('basic-page', $nid);			//looking for service name
